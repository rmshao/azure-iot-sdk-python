...
class X509Attestation(Model):
    ...
    :type client_certificates: ~serviceswagger.models.X509Certificates
    :param signing_certificates:
    :type signing_certificates: ~serviceswagger.models.X509Certificates
    :param ca_references:
    :type ca_references: ~serviceswagger.models.X509CAReferences
    """
    ...
    def __init__(self, *, client_certificates=None, signing_certificates=None, ca_references=None, **kwargs) -> None:
