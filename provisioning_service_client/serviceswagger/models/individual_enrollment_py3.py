...
class IndividualEnrollment(Model):
    ...
    def __init__(self, *, registration_id: str, attestation, capabilities=None, device_id: str=None, registration_state=None, iot_hub_host_name: str=None, initial_twin=None, etag: str=None, provisioning_status="enabled", created_date_time_utc=None, last_updated_date_time_utc=None, **kwargs) -> None:
