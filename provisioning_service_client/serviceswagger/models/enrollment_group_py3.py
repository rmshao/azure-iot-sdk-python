...
class EnrollmentGroup(Model):
    ...
    def __init__(self, *, enrollment_group_id: str, attestation, iot_hub_host_name: str=None, initial_twin=None, etag: str=None, provisioning_status="enabled", created_date_time_utc=None, last_updated_date_time_utc=None, **kwargs) -> None:
