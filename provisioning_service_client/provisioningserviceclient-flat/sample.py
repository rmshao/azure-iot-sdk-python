...
client.registry.create_or_update_device_enrollment(id="reg-id", enrollment=ie)

client.registry.create_or_update_device_enrollment_group(id="group-id", enrollment_group=eg)
